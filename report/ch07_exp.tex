...
\end{tabular}
\begin{flushleft}
\footnotesize $^\dagger$ linear 行取自细网格中对应 SNR；高 SNR 负增益见前文讨论。\\
\texttt{iq\_imbalance} 在 16\,dB 出现大幅负增益，与线性高 SNR 瓶颈同类。
\end{flushleft}
\end{table}
...
\begin{enumerate}[leftmargin=2em]
  ...
  \item \textbf{高 SNR 线性瓶颈}：稀有错误 + CSI/正则调度使 $G$ 可翻负；需更大测试集、更精细的高 SNR 核带宽/正则，或与线性估计器融合。
